	...
	public partial class DemoAppViewController : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			this.buttonEnableLocation.TouchUpInside += delegate(object sender, EventArgs e) {
				SHGeofence.instance().isLocationServiceEnabled = !SHGeofence.instance().isLocationServiceEnabled;
				RefreshStatus();
			};
		...
		{
			this.buttonEnableLocation.SetTitle (SHGeofence.instance().isLocationServiceEnabled ? "Location Status: Yes" : "Location Status: No", UIControlState.Normal);
		}
