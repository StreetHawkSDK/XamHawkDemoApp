	...
	public partial class DemoAppViewController : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			this.buttonEnableLocation.TouchUpInside += delegate(object sender, EventArgs e) {
				SHLocation.instance().isLocationServiceEnabled = !SHLocation.instance().isLocationServiceEnabled;
				RefreshStatus();
			};
		}
		...
		{
			this.buttonEnableLocation.SetTitle (SHLocation.instance().isLocationServiceEnabled ? "Location Status: Yes" : "Location Status: No", UIControlState.Normal);
		}
