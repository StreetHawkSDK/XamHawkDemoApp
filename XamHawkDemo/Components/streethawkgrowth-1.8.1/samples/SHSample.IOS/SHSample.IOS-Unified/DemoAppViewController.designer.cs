...
namespace SHSample.IOS
{
	...
	partial class DemoAppViewController
	{
		...
		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UIButton buttonGrowthShareCallback { get; set; }

		[Outlet]
		[GeneratedCode ("iOS Designer", "1.0")]
		UIButton buttonGrowthShareChannel { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (buttonGrowthShareCallback != null) {
				buttonGrowthShareCallback.Dispose ();
				buttonGrowthShareCallback = null;
			}
			if (buttonGrowthShareChannel != null) {
				buttonGrowthShareChannel.Dispose ();
				buttonGrowthShareChannel = null;
			}
